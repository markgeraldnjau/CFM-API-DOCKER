...
class TrainWagonClassController extends Controller
{
    use CommonTrait;
    /**
    ...
    {
        $wagonClasses = TrainWagonClass::select('id', 'name')->orderBy('id', 'asc')->get();

        return response()->json(['data' => $wagonClasses], HTTP_OK);
    }
